    ...
    <div class="site_list">
      <div class="wapper_sitelist">
        <ul class="road" :style="{width: listWidth + 'rem'}">
          <li class='part' v-for="(item, index) in siteList" :key="index" @click="showActive(index, item.siteName)">
...
export default {
  ...
  mounted: function () {
    qq.service(['qq.LineSearch'], function () {
      var linesearch = new qq.LineSearch({
        pageIndex: 1,
        city: this.city,
        pageSize: 20,
