  ...
  <div class="main">
    <div class="content">
      ...
      <form>
        ...
        <label for="card">就诊卡号</label>
        <div class="info">
          <input type="text" placeholder="请输入18位就诊卡号" id="card" v-model="card" @change="usercard"/>
        </div>
      </form>
      <div>
        ...
        if (this.card === '') {
          this.$messagebox.alert('社保卡号不可为空');
            ...
            if(!reg.test(this.card)){
              this.$messagebox.alert('请输入正确的就诊卡号');
            }
        }
    },
    saveMedicalCard () {
